...
function(_chowdsp_load_module module)
    ...
    # Clear both scopes before every recursive lookup. CMake's normal-variable
    # lookup otherwise leaks the prior module path into the next dependency.
    unset(chowdsp_module_path)
    unset(chowdsp_module_path CACHE)
    find_path(chowdsp_module_path
        NAMES "${module}.h"
        PATHS "${CHOWDSP_MODULES_DIR}/common/${module}"
