...
{
private:
    // Picolo runs at 48 kHz. 24,000 samples retain more than twice the longest
    // delay used by this processor while reducing per-instance mobile memory.
    Allpass<T, 24000> allpass[4] = {};
    StaticAllpassFourTap<T, 24000> allpassFourTap[4] = {};
    StateVariable<T,4> bandwidthFilter[2] = {};
    StateVariable<T,4> damping[2] = {};
    StaticDelayLine<T, 24000> predelay = {};
    StaticDelayLineFourTap<T, 24000> staticDelayLine[4] = {};
    StaticDelayLineEightTap<T, 24000> earlyReflectionsDelayLine[2] = {};
    T SampleRate = {};
    T DampingFreq = {};
    T Density1 = {};
    T Density2 = {};
